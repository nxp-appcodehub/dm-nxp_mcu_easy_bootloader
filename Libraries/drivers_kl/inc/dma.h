...
//!< DMA
#define HW_DMA_CH0    (0x00)  //DMA0
#define HW_DMA_CH1    (0x01)  //DMA1
#define HW_DMA_CH2    (0x02)  //DMA2
#define HW_DMA_CH3    (0x03)  //DMA3

//!< 
typedef enum
{
    kDMA_TrigSrc_Normal,    //
    kDMA_TrigSrc_Periodic,  //
}DMA_TrigSrcMod_t;
...
{
    uint8_t                     chl;                                /* DMA */       
    uint8_t                     chlTrigSrc;                   /* DMA */
    uint16_t                    transCnt;
    DMA_TrigSrcMod_t            trigSrcMod;                  /*  */
    /*  */
    bool                        sAddrIsInc;
    uint32_t                    sAddr;                      /*  */
    DMA_DataWidth_t             sDataWidth;                 /*  8 16 32 */
    DMA_Modulo_Type             sMod;                       /* Modulo   AN2898 */
    /*  */
    bool                        dAddrIsInc;                
    uint32_t                    dAddr;                      
