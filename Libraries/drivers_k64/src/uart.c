...
/**
 * @brief  DMA
 * @note   DMATx  DMA(UART, LPUART)
 * @param  instance:
 *         @arg HW_UARTx : UART0-5
 * @param  mode:
 *         @arg kUART_DMATx : UART-DMA 
 *         @arg kUART_DMARx : UART-DMA 
 * @param  val : 
 *         @arg 0 : UART DMA
 *         @arg 1 : UART DMA
 * @retval CH_OK :; :
 ...
 *         @arg HW_UARTx : UART0-5
 * @param  mode:
 *         @arg kUART_IntTx : UART- 
 *         @arg kUART_IntRx : UART- 
 *         @arg kUART_IntIdleLine : UART-IDLE
 * @param  val : 
 *         @arg true : 
 *         @arg false : 
 * @retval CH_OK :; :
